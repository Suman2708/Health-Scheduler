...
const DoctorProfile = () => {
  ...
  const {backendUrl,profileData,setProfileData,getProfileData,dToken}=useContext(DoctorContext)
  ...
  const updateProfile=async()=>{
    try {
      ...
      const updateData={
        ...
        const response= await fetch(`${backendUrl}/api/doctor/update-doctor`,{
                      method:'POST',
                      headers:{
    ...
    <div>
      ...
      '>
        ...
        <div className=' flex-1 border  border-stone-100 rounded-lg p-8 py-7 bg-white'>
          {/* ---------Doc Info : nme,degree,experience--------- */}
