  ...
  return (
    ...
    {/* left side */}
       <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px] ">
        ...
        <div className=" flex flex-col md:flex-row items-center gap-e text-white text-sm font-light ">
            <img className=" w-28  " src={assets.group_profiles} alt="" />
            <p>Simply brose through our extensive list of trusted doctors, <br className="hidden sm:block " /> schedule your appintment hassle-free</p>
        </div>
